...
import br.com.trabalho2Usuario.util.SenhaUtil;
...
public class UsuarioDAO {
   public void inserir(Usuario usuario) throws SQLException {
    ...
    String sql = "INSERT INTO usuario "
            + "(nome, email, telefone, cep, endereco, numero, cidade, estado, senha, perfil) "
            + "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    try (Connection conn = Conexao.conectar();
        ...
        stmt.setString(10, usuario.getPerfil());
...
public Usuario login(String email, String senha) throws SQLException {
    ...
    String sql = "SELECT id, nome, email, telefone, cep, endereco, numero, cidade, estado, senha, perfil " +
